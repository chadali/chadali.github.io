...
iosDevelopment.updateDescriptions([<span><div className="projectHeader">Test Driven Development</div><div className="projectDescription">More Description</div></span>, <span><div className="projectHeader">Storyboard Tutorial</div><div className="projectDescription">More Description</div></span>, <span><div className="projectHeader">IOS Note Taking Application</div><div className="projectDescription">More Description</div></span>,<span><div className="projectHeader">IOS Calculator Application</div><div className="projectDescription">More Description</div></span>]);
